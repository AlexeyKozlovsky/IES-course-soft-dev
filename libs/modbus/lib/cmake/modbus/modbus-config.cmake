# CMake package config file for modbus library.
#
...
####### The input file was modbus-config.cmake.in                            ########
...
macro(import_targets type)
    if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/modbus-${type}-targets.cmake")
        set(${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE "modbus ${type} libraries were requested but not found")
        set(${CMAKE_FIND_PACKAGE_NAME}_FOUND OFF)
        return()
    endif()

    include("${CMAKE_CURRENT_LIST_DIR}/modbus-${type}-targets.cmake")
endmacro()
...
if(NOT TARGET modbus::modbus)
    ...
    elseif(BUILD_SHARED_LIBS AND EXISTS "${CMAKE_CURRENT_LIST_DIR}/modbus-shared-targets.cmake")
        set(type "shared")
    elseif(EXISTS "${CMAKE_CURRENT_LIST_DIR}/modbus-static-targets.cmake")
        set(type "static")
    else()
        set(type "shared")
    endif()
    ...
    import_targets(${type})
    check_required_components(modbus)
    message("-- Found ${type} modbus (version ${${CMAKE_FIND_PACKAGE_NAME}_VERSION})")
endif()
